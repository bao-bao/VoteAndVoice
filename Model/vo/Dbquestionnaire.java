...
public class Dbquestionnaire {
    ...
    public String getQn_delay() {
        return qn_delay;
    }

    public void setQn_delay(String qn_delay) {
        this.qn_delay = qn_delay;
    }
    ...
    public void setAll(ResultSet rs) throws SQLException {
        try {
            ...
            this.setQn_delay(rs.getString("qn_delay"));
    ...
    public String get_transQn_state() {
        if (qn_state.equals("dly")) {
            return "未发布";
        } else if (qn_state.equals("ing")) {
            return "进行中";
    ...
    public void set_transQn_state(String qn_state) {
        if (qn_state.equals("未发布")) {
            this.qn_state = "dly";
        } else if (qn_state.equals("进行中")) {
            this.qn_state = "ing";
    ...
    public String get_transQn_delay() {
        return qn_delay;
    }

    public void set_transQn_delay(String qn_delay) {
        this.qn_delay = qn_delay;
    }
}
